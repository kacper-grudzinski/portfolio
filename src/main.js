  ...
  .then((response) => {
    for (let repository of response) {
      ...
      const element = `<article
        ...
        >
          <span class="hover:bg-red-600 h-3 w-3 block rounded-full bg-bg opacity-50"></span>
          <span class="h-3 w-3 block rounded-full bg-bg opacity-50"></span>
          <span class="h-3 hover:bg-orange-400 w-3 block rounded-full bg-bg opacity-50"></span>
        </div>
